...
function createNote() {
  ...
  node1.setAttribute(
    'style',
    'width: 250px; heigth: 250px; font-size:25px; padding: 25px; margin-top: 10px; overflow: hidden; box-shadow: 0px 10px 24px 0px rgba(0,0,0,0.75)'
  )
